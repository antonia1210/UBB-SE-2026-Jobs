...
{
    IReadOnlyDictionary<TraitType, double> CalculateTraitScores(IReadOnlyDictionary<PersonalityQuestion, AnswerValue> answers);
    ...
    Task SaveResultAsync(int userId, IReadOnlyDictionary<PersonalityQuestion, AnswerValue> answers, JobRole selectedRole, CancellationToken cancellationToken = default);
