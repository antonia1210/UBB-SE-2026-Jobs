namespace UBB_SE_2026_Jobs.Library.Services
{
    ...
    /// </summary>
    public class TestsCompanyService : ITestsCompanyService
    {
        private readonly ITestsCompanyRepository _repository;

        /// <summary>
        /// Initializes a new instance of the <see cref="TestsCompanyService"/> class.
        /// </summary>
        /// <param name="repository">The repository used to access company data. Cannot be null.</param>
        public TestsCompanyService(ITestsCompanyRepository repository)
        {
