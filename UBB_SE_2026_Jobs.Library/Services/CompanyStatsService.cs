namespace UBB_SE_2026_Jobs.Library.Services
{
    ...
    public class CompanyStatsService : ICompanyStatsService
    {
        ...
        private readonly ITestsJobsRepository _jobsRepository;
        private readonly IApplicantRepository _applicantRepository;

        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyStatsService"/> class.
        /// </summary>
        /// <param name="TestsJobsRepository">The repository used to access job data. Cannot be null.</param>
        /// <param name="applicantRepository">The repository used to access applicant data. Cannot be null.</param>
        public CompanyStatsService(ITestsJobsRepository TestsJobsRepository, IApplicantRepository applicantRepository)
        {
            this._jobsRepository = TestsJobsRepository;
