...
namespace UBB_SE_2026_Jobs.Library.Services
{
    ...
    public class GradingService : IGradingService
    {
        ...
        public void GradeSingleChoice(TestQuestion question, Answer answer)
        {
        ...
        public void GradeMultipleChoice(TestQuestion question, Answer answer)
        {
            if (question.QuestionAnswer == null)
            {
                return;
        ...
        /// <param name="question">The question being graded.</param>
        /// <param name="answer">The answer provided by the user.</param>
        public void GradeText(TestQuestion question, Answer answer)
        {
            if (question.QuestionAnswer == null)
            {
                return;
        ...
        public void GradeTrueFalse(TestQuestion question, Answer answer)
        {
            if (question.QuestionAnswer == null)
            {
                return;
