namespace UBB_SE_2026_Jobs.Library.Services.Interfaces
{
    ...
    public interface IGradingService
    {
        ...
        void GradeSingleChoice(TestQuestion question, Answer answer);
        ...
        void GradeMultipleChoice(TestQuestion question, Answer answer);
        ...
        /// <param name="question">The question being graded.</param>
        /// <param name="answer">The answer provided by the user.</param>
        void GradeText(TestQuestion question, Answer answer);
        ...
        void GradeTrueFalse(TestQuestion question, Answer answer);
