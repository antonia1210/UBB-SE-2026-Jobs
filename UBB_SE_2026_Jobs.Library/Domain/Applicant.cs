namespace UBB_SE_2026_Jobs.Library.Domain
{
    ...
    /// The Applicant class is mapped to the "applicants" table in the database, with a primary key of ApplicantId that is not auto-generated. It also includes navigation properties for related entities such as Job,
    ...
    public class Applicant
    {
        ...
        /// <summary>
        /// Gets or sets the unique identifier for the job associated with the applicant's application. This property is mapped to the "job_id" column in the database and represents a foreign key relationship to the Job entity.
        /// </summary>
        [Column("job_id")]
        public int JobId { get; set; }

        /// <summary>
        /// Gets or sets the job associated with the applicant's application. This property represents a navigation property to the Job entity, allowing for access to the job's details and related information.
        /// </summary>
