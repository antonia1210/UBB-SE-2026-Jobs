namespace UBB_SE_2026_Jobs.Library.Repositories
{
    ...
    public class TestsCompanyRepository : ITestsCompanyRepository
    {
        ...
        public TestsCompanyRepository(JobsDbContext JobsDbContext)
        {
        ...
        public void SaveGame(Game game)
        {
            ...
            var existing = this.JobsDbContext.Companies.Find(this.currentCompany.CompanyId);
            if (existing == null)
            {
                return;
            }
        ...
        {
            var companies = this.JobsDbContext.Companies.ToList();
        ...
        {
            var company = this.JobsDbContext.Companies
        ...
        void ITestsCompanyRepository.Add(Company company)
        {
            ...
            this.JobsDbContext.Companies.Add(company);
            this.JobsDbContext.SaveChanges();
        }
        ...
        void ITestsCompanyRepository.Remove(int companyId)
        {
            ...
            if (company != null)
            {
                this.JobsDbContext.Companies.Remove(company);
                this.JobsDbContext.SaveChanges();
            }
        }
        ...
        void ITestsCompanyRepository.Update(Company company)
        {
            ...
            var existing = this.JobsDbContext.Companies.Find(company.CompanyId);
            if (existing == null)
            {
        ...
        {
            List<Company> companies = this.JobsDbContext.Recruiters
                .Where(c => c.UserId == recruiterId)
                .Join(this.JobsDbContext.Companies,
                    r => r.CompanyId,
                    c => c.CompanyId,
                    (r, c) => c)
                .ToList();
