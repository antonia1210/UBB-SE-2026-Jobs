...
namespace UBB_SE_2026_Jobs.Library.Repositories.Users;

public class UserRepository : IUserRepository
{
    private readonly JobsDbContext databaseContext;

    public UserRepository(JobsDbContext databaseContext)
    {
    ...
    /// <summary>
    /// Read-only listing â€” no Includes to keep the query light. Callers that need detail load
    ...
    /// <summary>
    /// Soft-delete primitive â€” toggles ActiveAccount without touching match history. Original
