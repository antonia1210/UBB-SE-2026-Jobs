...
public class UserSkillRepository : IUserSkillRepository
{
    ...
    public UserSkillRepository(JobsDbContext databaseContext)
    {
    ...
    /// <summary>
    /// Original: PussyCatsApp UserSkillRepository.GetVerifiedSkillsByUserId â€” the original SQL
    ...
    /// AchievedDate IS NOT NULL â€” both must hold for a skill to count as "verified", per the
