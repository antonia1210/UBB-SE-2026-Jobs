...
namespace UBB_SE_2026_Jobs.Library.Repositories.Recommendations;

public class RecommendationRepository : IRecommendationRepository
{
    private readonly JobsDbContext databaseContext;

    public RecommendationRepository(JobsDbContext databaseContext)
    {
    ...
    /// <summary>
    /// Original: matchmaking SqlRecommendationRepository.GetLatestByUserIdAndJobId â€” preserves
