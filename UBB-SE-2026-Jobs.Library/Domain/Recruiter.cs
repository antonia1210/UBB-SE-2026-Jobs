namespace UBB_SE_2026_Jobs.Library.Domain 
{
    ...
    /// The Recruiter class is mapped to the "Recruiters" table in the database, with a primary key of CompanyId that is not auto-generated.
    /// It also includes navigation properties for related entities such as Company, AssignedCandidates, and Slots.
    /// </summary>
    [Table("Recruiters")]
    public class Recruiter
    {
        /// <summary>
        /// Gets or sets the unique identifier for the recruiter, which is also the primary key for the Recruiters table.
        /// This property is not auto-generated, meaning that it must be explicitly set when creating a new Recruiter instance.
