namespace UBB_SE_2026_Jobs.Library.TestsAndInterviews.Data
{
    using Microsoft.EntityFrameworkCore;
    using UBB_SE_2026_Jobs.Library.TestsAndInterviews.Helpers;
    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(UBB_SE_2026_Jobs.Library.TestsAndInterviews.Helpers.Env.CONNECTION_STRING);
            }
        }
        ...
        {
            // These tables are owned and migrated by PussyCatsDbContext — exclude them here.
            modelBuilder.Entity<User>().ToTable("Users", tb => tb.ExcludeFromMigrations());
            modelBuilder.Entity<Company>().ToTable("companies", tb => tb.ExcludeFromMigrations());
            modelBuilder.Entity<JobPosting>().ToTable("jobs", tb => tb.ExcludeFromMigrations());
            modelBuilder.Entity<Skill>().ToTable("Skills", tb => tb.ExcludeFromMigrations());
            modelBuilder.Entity<JobSkill>()
                .HasKey(js => new { js.SkillId, js.JobId });
            modelBuilder.Entity<JobSkill>()
                .ToTable("JobSkills", tb => tb.ExcludeFromMigrations());
